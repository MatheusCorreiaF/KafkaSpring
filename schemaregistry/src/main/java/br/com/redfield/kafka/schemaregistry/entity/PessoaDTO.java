...
public class PessoaDTO extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6066992730613295523L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PessoaDTO\",\"namespace\":\"br.com.redfield.kafka.schemaregistry.entity\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"lastName\",\"type\":\"string\"}]}");
   ...
   */
  public static br.com.redfield.kafka.schemaregistry.entity.PessoaDTO.Builder newBuilder() {
    return new br.com.redfield.kafka.schemaregistry.entity.PessoaDTO.Builder();
  }
   ...
   * @return A new PessoaDTO RecordBuilder
   */
  public static br.com.redfield.kafka.schemaregistry.entity.PessoaDTO.Builder newBuilder(br.com.redfield.kafka.schemaregistry.entity.PessoaDTO.Builder other) {
    return new br.com.redfield.kafka.schemaregistry.entity.PessoaDTO.Builder(other);
  }
   ...
   * @return A new PessoaDTO RecordBuilder
   */
  public static br.com.redfield.kafka.schemaregistry.entity.PessoaDTO.Builder newBuilder(br.com.redfield.kafka.schemaregistry.entity.PessoaDTO other) {
    return new br.com.redfield.kafka.schemaregistry.entity.PessoaDTO.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PessoaDTO>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(br.com.redfield.kafka.schemaregistry.entity.PessoaDTO.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(br.com.redfield.kafka.schemaregistry.entity.PessoaDTO other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.redfield.kafka.schemaregistry.entity.PessoaDTO.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.redfield.kafka.schemaregistry.entity.PessoaDTO.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.redfield.kafka.schemaregistry.entity.PessoaDTO.Builder setLastName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.redfield.kafka.schemaregistry.entity.PessoaDTO.Builder clearLastName() {
      lastName = null;
